...
import OurBlog from "../blog/OurBlog.tsx";
import Footer from "../Footer.tsx";
import wa1 from '../../assets/clocks/featureone.svg'
            ...
            <div
                ...
                <div className={'mt-[174px] px-[85px] flex flex-col'}>
                    <div className={'w-full flex-row gap-[10px] flex justify-end items-center'}>
                        <h6 className={'worksansregular text-[20px] text-darkblue'}>
                            Close
                        </h6>
                        <svg width="21" height="22" viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_4030_1237)">
                                <path d="M17.0004 4.0752L3.40039 17.6752M17.0004 17.6752L3.40039 4.0752"
                                      stroke="#1F2937" stroke-width="1.275"/>
                            </g>
                            <defs>
                    ...
                    <div className={'flex flex-row gap-[40px]'}>
                        <div className={'flex flex-col gap-[20px]'}>
                            <img className={'w-[516px] h-[520px] object-cover'} src={wa1} alt=""/>
                            <div className={'flex flex-row gap-[20px]'}>
                                <img className={'w-[33%] h-[151px] object-cover'} src={wa1} alt=""/>
                                <img className={'w-[33%] h-[151px] object-cover'} src={wa1} alt=""/> <img
                                className={'w-[33%] h-[151px] object-cover'} src={wa1} alt=""/>
